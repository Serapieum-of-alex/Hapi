...
# Parameterpath = Comp + "/Coello/Hapi/Model/results/parameters/lumped/Coello_Lumped2021-03-08.txt"
Parameterpath = Comp + "/Coello/Hapi/Model/results/parameters/01lumped model/Coello_Lumped2021-03-08_muskingum.txt"
BoundaryPath = Comp + "/Coello/Hapi/Data/00inputs/Basic_inputs"

Meteopath = Comp + "/Coello/Hapi/Data/00inputs/Lumped Model/"
