...
toolbox.register("individual", tools.initIterate, creator.IndividualContainer, toolbox.initialRange)
...
ParPath = Path + f"{Coello.name}-lumped-parameters" + str(dt.datetime.now())[0:10] + ".txt"
...
Path = Path + f"{Coello.name}-results-lumped-model" + str(dt.datetime.now())[0:10] + ".txt"
