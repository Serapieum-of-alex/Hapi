...
The required inputs for the distributed model is divided into Meteorological and GIS inputs, where the meteorological
inputs are temperature,  evapotranspiration, and rainfall
