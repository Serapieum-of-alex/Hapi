...
GoogleFile = open("HAPI/static/input_data/Google API.txt")
...
def generate_dist_data():
    ...
    x,y=GIS.reproject_points(stations_coor_ds.data['lat'][0],stations_coor_ds.data['long'][0])
    ...
    #    poly_df.loc[coords.keys()[i],"geometry"]=GIS.create_polygon(coords[coords.keys()[i]])
...
boundary=GIS.XY(boundary)
rainfall_station=GIS.XY(rainfall_station)
runoff_station=GIS.XY(runoff_station)
# colors 
